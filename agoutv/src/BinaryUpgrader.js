...
import { HOSTS, BINARY_VERSION } from "./Constants";
import { checkUpgrade } from "./middlewares/api";
...
export default class BinaryUpgrader {
    ...
    _checkAndroid(onStatusChanged, onProgress) {
        const upgrader = new AppUpdate({
            apkVersionUrl: launchSettings.apiHosts.update + '/api/app/checkUpgrade/android?channel_id=' + launchSettings.channelID,
